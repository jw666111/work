...
|----------|----------|------|--------|----------|
| **体验包** | 资源包 | 新用户入门体验，小额尝试 | 1年 | 限购1个 |
| **包月** | 按月套餐 | 按月购买，固定时长内享受额度 | 30天/月 | 可叠加购买 |
| **按量** | 资源包 | 一次性购买，用完即止 | 1年 | 可叠加购买 |

### 2.2 首期上线套餐

#### 2.2.1 体验包
- **体验套餐**：新用户入门包， 9.9 元（价格待定）
...
| 失效套餐 | 使用灰色或半透明样式区分或表格汇总，保留历史记录查看 |
